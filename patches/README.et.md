...
## 🚀 Patchide Paigalduskäsud

```bash
# APEXi Bundle Patchi Paigaldamine:
./scripts/internal/apply-apex-patch.sh binaries/apex/patches/p39179920_261_Generic.zip

# Analytics Publisheri OPatchi Paigaldamine:
./scripts/internal/apply-publisher-patch.sh binaries/publisher/patches/<patch_fail>.zip
```
