...
- **`devhub_browser_blueprints_benchmarks.json`**: E2E-selain- ja API-testien mittarit.

*(Huomautus: Yksityiskohtaiset asennuslokit tallennetaan vain paikallisesti kansioon `install_logs/` eivätkä mene Gitiin).*
