...
- **`devhub_browser_blueprints_benchmarks.json`**: E2E pārlūkprogrammas un API testa rādītāji.

*(Piezīme: Pilni instalēšanas žurnāli tiek saglabāti tikai lokāli mapē `install_logs/` un netiek iekļauti Git).*
