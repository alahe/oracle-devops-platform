...
- **`devhub_browser_blueprints_benchmarks.json`**: E2E naršyklės ir API testų rodikliai.

*(Pastaba: Išsamūs diegimo žurnalai saugomi tik vietiškai kataloge `install_logs/` ir nepatenka į Git).*
