...
## 📅 Genereeritud: 2026-09-14 08:08:53
...
| **`refresh-devhub.sh`** | ✅ Kaetud | [`test-script-refresh-devhub.sh`](../unit/test-script-refresh-devhub.sh) |
...
| **`release.sh`** | ✅ Kaetud | [`test-semantic-versioning.sh`](../unit/test-semantic-versioning.sh) |
| **`report-repo-stats.sh`** | ✅ Kaetud | [`report-repo-stats.sh`](../report-repo-stats.sh) |
...
| **`test-apex-suite.sh`** | ✅ Kaetud | [`test-script-test-apex-suite.sh`](../unit/test-script-test-apex-suite.sh) |
| **`test-browser-login.sh`** | ✅ Kaetud | [`test-all-blueprints-incremental.sh`](../test-all-blueprints-incremental.sh),[`test-all-components.sh`](../test-all-components.sh),[`test-browser-login.sh`](../test-browser-login.sh) |
...
| **`test-security-audit.sh`** | ✅ Kaetud | [`test-security-audit.sh`](../unit/test-security-audit.sh),[`test-security-audit.sh`](../test-security-audit.sh) |
| **`test-windows-dryrun.sh`** | ✅ Kaetud | [`test-windows-dryrun.sh`](../unit/test-windows-dryrun.sh),[`test-local-ci.sh`](../test-local-ci.sh),[`test-windows-dryrun.sh`](../test-windows-dryrun.sh) |
...
| **`internal/check-prerequisites.sh`** | ✅ Kaetud | [`test-script-check-prerequisites.sh`](../unit/test-script-check-prerequisites.sh),[`test-windows-enterprise-rules.sh`](../unit/test-windows-enterprise-rules.sh) |
| **`internal/common.sh`** | ✅ Kaetud | [`test-artifactory-client.sh`](../unit/test-artifactory-client.sh),[`test-compact-terminal-ux.sh`](../unit/test-compact-terminal-ux.sh),[`test-container-naming-isolation.sh`](../unit/test-container-naming-isolation.sh),[`test-custom-image-naming-pattern.sh`](../unit/test-custom-image-naming-pattern.sh),[`test-script-artifactory-client.sh`](../unit/test-script-artifactory-client.sh),[`test-script-common.sh`](../unit/test-script-common.sh),[`test-script-snapshot-resolver.sh`](../unit/test-script-snapshot-resolver.sh),[`test-snapshot-resolver.sh`](../unit/test-snapshot-resolver.sh),[`test-publisher-accessibility-suite.sh`](../integration/test-publisher-accessibility-suite.sh),[`test-publisher-deploy-verify-e2e.sh`](../integration/test-publisher-deploy-verify-e2e.sh),[`test-publisher-report-lab-e2e.sh`](../integration/test-publisher-report-lab-e2e.sh),[`test-all-blueprints-incremental.sh`](../test-all-blueprints-incremental.sh),[`test-all-blueprints-live.sh`](../test-all-blueprints-live.sh),[`test-devhub-browser-blueprints.sh`](../test-devhub-browser-blueprints.sh),[`test-devhub-lifecycle-full.sh`](../test-devhub-lifecycle-full.sh),[`test-ords-lifecycle-matrix.sh`](../test-ords-lifecycle-matrix.sh),[`test-remote-multicloud.sh`](../test-remote-multicloud.sh),[`test-security-audit.sh`](../test-security-audit.sh) |
...
| **`internal/configure-publisher-sso.sh`** | ❌ Kaetus puudub | - |
...
| **`internal/export-ci-secrets.sh`** | ✅ Kaetud | [`test-script-export-ci-secrets.sh`](../unit/test-script-export-ci-secrets.sh),[`test-github-actions-local.sh`](../integration/test-github-actions-local.sh),[`test-local-ci.sh`](../test-local-ci.sh) |
...
| **`internal/generate-dev-hub.sh`** | ✅ Kaetud | [`test-dev-hub-generation.sh`](../unit/test-dev-hub-generation.sh),[`test-devhub-mermaid-rendering.sh`](../unit/test-devhub-mermaid-rendering.sh),[`test-devhub-recipes-safety.sh`](../unit/test-devhub-recipes-safety.sh),[`test-devhub-specs-triad.sh`](../unit/test-devhub-specs-triad.sh),[`test-live-platform.sh`](../test-live-platform.sh) |
...
| **`internal/init-publisher-users.sh`** | ❌ Kaetus puudub | - |
...
| **`internal/run_blueprint_matrix_test.sh`** | ✅ Kaetud | [`test-script-run-blueprint-matrix-test.sh`](../unit/test-script-run-blueprint-matrix-test.sh) |
...
| **`internal/sync-apex-images.sh`** | ✅ Kaetud | [`test-script-sync-apex-images.sh`](../unit/test-script-sync-apex-images.sh) |
...
- **Kogu skriptide arv (Total Scripts):** 78
- **Testidega kaetud skripte (Covered Scripts):** 75
- **Automaattestide kaetus (Test Coverage):** **96%**
