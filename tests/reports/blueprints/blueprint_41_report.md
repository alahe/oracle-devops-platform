# Blueprinti 41 Testiaruanne (2026-08-30 16:25:00)

- **Aeg ja Kuupäev:** 2026-08-30 16:25:00
- **Kogu Paigalduse Kestus:** 10m 34s
- **Blueprinti Fail:** `config/blueprints/.env.41-*`

---

## 1. ⏱ Ajakulu ja Tervisekontroll (Duration & Health)
- **Tulemus:** ✅ Paigaldus ja tervisekontrollid läbitud 100% korrektselt.
- **Kestus kokku:** 10m 34s
...
| :--- | :--- | :--- | :--- |
| web-ide-dev | 1.17% | 75.97MB / 8.297GB | 0.92% |
| db-proxy | 36.54% | 747.9MB / 3.221GB | 23.22% |
| app-ords | 21.04% | 583MB / 1.074GB | 54.30% |
| app-publisher | 217.42% | 4.15GB / 8.297GB | 50.01% |
| app-forms | 0.28% | 10.18MB / 8.297GB | 0.12% |
...
| :--- | :--- | :--- |
| web-ide-dev | Up 11 minutes (starting) | 0.0.0.0:8090->8443/tcp, 0.0.0.0:8091->8091/tcp, 0.0.0.0:8449->8443/tcp |
| db-proxy | Up 11 minutes (healthy) | 127.0.0.1:1532->1521/tcp |
