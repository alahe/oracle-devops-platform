# Blueprinti 33 Testiaruanne (2026-08-30 15:54:41)

- **Aeg ja Kuupäev:** 2026-08-30 15:54:41
- **Kogu Paigalduse Kestus:** 11m 52s
- **Blueprinti Fail:** `config/blueprints/.env.33-*`

---

## 1. ⏱ Ajakulu ja Tervisekontroll (Duration & Health)
- **Tulemus:** ✅ Paigaldus ja tervisekontrollid läbitud 100% korrektselt.
- **Kestus kokku:** 11m 52s
...
| :--- | :--- | :--- | :--- |
| web-ide-dev | 1.14% | 80.66MB / 8.297GB | 0.97% |
| db-proxy | 11.74% | 558.1MB / 3.221GB | 17.33% |
| db-publisher | 10.98% | 543.4MB / 3.221GB | 16.87% |
| db-alise | 7.03% | 535.3MB / 3.221GB | 16.62% |
| app-ords | 92.92% | 564.1MB / 1.074GB | 52.54% |
| app-publisher | 140.55% | 260.5MB / 8.297GB | 3.14% |
...
| db-publisher | Up 16 minutes (healthy) | 127.0.0.1:1531->1521/tcp |
| db-alise | Up 5 minutes (healthy) | 127.0.0.1:1533->1521/tcp |
| app-ords | Up 29 seconds (starting) | 127.0.0.1:8088->8088/tcp, 127.0.0.1:8448->8448/tcp |
...
| APEX Builder (ALISE) | `https://localhost:8448/ords/alise/r/apex/workspace-sign-in/oracle-apex-sign-in` | `HTTP 000` | ⚠️ Self-Signed | ❌ Kättesaamatu |
