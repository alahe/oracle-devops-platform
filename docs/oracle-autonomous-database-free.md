# ☁️ Oracle Autonomous Database (ADB) Free Container Guide

Oracle Autonomous AI Database Free container image supports 2 types of database workload types: **Lakehouse (ADW)** and **Transaction Processing (ATP)**, similar to Oracle Autonomous AI Database in OCI Cloud.

### 🌟 Supported Key Features:
- 🚀 **Oracle REST Data Services (ORDS)**
- 💻 **Oracle APEX**
- 📊 **Database Actions (SQL Developer Web)**
- 🍃 **MongoDB API & JSON Collections**
- 🌐 **Oracle Estate Explorer (OEE)**
- 💾 **Storage:** Up to 20 GB user data per container
