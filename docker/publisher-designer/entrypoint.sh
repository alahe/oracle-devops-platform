...
Exec=/u01/oracle/bin/render-template.sh /u01/templates/samples/arve_eesti_standard.rtf /u01/templates/samples/arve_näidisandmed.xml /u01/templates/samples/valmis_arve.pdf
